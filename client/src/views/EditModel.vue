<template>
  <div class="container">
    <div class='window'>
      ...
      <div class='content'>
        <div class='welcome'>Изменение модели</div>
        ...
        <div>
          <button class='ghost-round full-width' @click="EditModel">Изменить</button>
        </div>
...
export default {
  ...
  methods: {
    getModel(){
      Concurs.GetOneModel({id: this.$route.params.id})
          .then(modelTemp => {
            const model = modelTemp.data.dataValues;
